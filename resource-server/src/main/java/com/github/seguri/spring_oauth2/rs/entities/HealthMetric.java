package com.github.seguri.spring_oauth2.rs.entities;

import com.github.seguri.spring_oauth2.rs.entities.enums.HealthMetricType;
...
public class HealthMetric {
  ...
  @Basic private double value;

  @Enumerated(EnumType.STRING)
  private HealthMetricType type;

  @ManyToOne private HealthProfile profile;
